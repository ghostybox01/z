...
PROVIDER_META = {
    ...
    "seznam": {
        "name": "Seznam.cz (Czech Republic)",
        "smtp_delay": 2.5,
        "max_per_hr": 400,
    },
    "wp_pl": {
        "name": "WP.pl / Onet / O2 (Poland)",
        "smtp_delay": 2.5,
        "max_per_hr": 400,
    },
    "proximus": {
        "name": "Proximus / Belgacom (Belgium)",
        "smtp_delay": 2.5,
        "max_per_hr": 400,
    },
    "telenet_be": {"name": "Telenet (Belgium)", "smtp_delay": 2.5, "max_per_hr": 400},
    "ziggo": {
        "name": "Ziggo / XS4ALL (Netherlands)",
        "smtp_delay": 2.5,
        "max_per_hr": 400,
    },
    "bigpond": {
        "name": "Bigpond / Telstra (Australia)",
        "smtp_delay": 2.5,
        "max_per_hr": 400,
    },
    ...
    "mimecast": {
        "name": "Mimecast (Enterprise Filter)",
        "smtp_delay": 6.0,
        "max_per_hr": 150,
    },
    "proofpoint": {
        "name": "Proofpoint (Enterprise Filter)",
        "smtp_delay": 6.0,
        "max_per_hr": 150,
    },
...
def sort_leads(leads: list, workers: int = 20, timeout: int = 30) -> dict:
    if not leads:
        return {}
    emails = [(lead.get("email") or "") for lead in leads if isinstance(lead, dict)]
